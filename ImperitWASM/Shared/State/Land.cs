...
namespace ImperitWASM.Shared.State
{
	public class Land : Province
	{
		...
		public Land(int id, string name, Shape shape, Army army, Army defaultArmy, bool isStart, int earnings, ImmutableList<IAction> actions, Settings settings)
		...
		protected override Province WithActions(ImmutableList<IAction> new_actions) => new Land(Id, Name, Shape, Army, DefaultArmy, IsStart, Earnings, new_actions, settings);
