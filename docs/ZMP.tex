...
Moře se odtrhne, pokud v něm hráč nemá žádné jednotky. Země se může hráči odtrhnout vždy po jeho tahu, přičemž pravděpodobnost odtržení je pro zemi bez armády 10 \% a klesá s růstem obranné síly armády v zemi tak, aby se země nemohla odtrhnout, když má její armáda obrannou sílu stejnou nebo vyšší než na začátku hry.
\subsection{Peníze}
Hráč získá po svém tahu daňový výnos z každé země, jež mu patří. Tento výnos se může lišit u různých zemí. Obvykle mají vyšší výnos země, které mají na začátku hry více vojáků. Za peníze je možné kupovat další země nebo vojenské jednotky, s nimiž lze dobývat provincie a bránit provincie už dobyté.

Pokud hráč dluží nějaké peníze, jsou mu po získání daňového výnosu zabaveny peníze ke splacení dluhu. Pokud všechny jeho peníze ke splacení dluhu nestačí, je zbývající dluh navýšen o úrok 10 \% a zůstává hráči do dalšího kola.
